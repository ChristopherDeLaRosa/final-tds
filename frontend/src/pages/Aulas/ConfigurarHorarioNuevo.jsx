...
const ConfigurarHorarioNuevo = ({ aulaId, onClose, onSuccess }) => {
  ...
  const guardarHorarioCompleto = async () => {
    ...
    try {
      ...
      console.log("Enviando datos:", configDto); // Para debug
        ...
        await MySwal.fire({
          ...
          html: `
            <div style="text-align: left;">
              ...
              <p>✓ ${resultado.gruposCursosCreados} Secciones generadas</p>
              ...
              {bloques.map((bloque, bloqueIdx) => (
                <FilaHorario key={bloqueIdx}>
                  <CeldaHora>
                    ...
                    <HoraTexto $small="true">{bloque.fin}</HoraTexto>
                  </CeldaHora>
                  ...
                  <BlockRangeContainer>
                    ...
                    <BlockSelect
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          bloqueFin: parseInt(e.target.value),
                        })
                      }
                    >
                      {bloques
